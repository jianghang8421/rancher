...
func Mirror(image string) string {
	...
	image = strings.Replace(image, "gcr.io/google_containers", "jianghang8421", 1)
	image = strings.Replace(image, "quay.io/coreos/", "jianghang8421/coreos-", 1)
	image = strings.Replace(image, "quay.io/calico/", "rancher/calico-", 1)
	image = strings.Replace(image, "k8s.gcr.io/", "jianghang8421/nginx-ingress-controller-", 1)
