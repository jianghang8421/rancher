...
var (
	...
	AllArm64K8sVersions = map[string]RKESystemImages{
		...
		"v1.13.1-rancher1-1": {
			Etcd:                      m("quay.io/coreos/etcd:v3.2.24-arm64"),
			Kubernetes:                m("jianghang8421/hyperkube:v1.13.1-rancher1"),
			Alpine:                    m("jianghang8421/rke-tools:v0.1.23"),
			NginxProxy:                m("jianghang8421/rke-tools:v0.1.23"),
			CertDownloader:            m("jianghang8421/rke-tools:v0.1.23"),
			KubernetesServicesSidecar: m("jianghang8421/rke-tools:v0.1.23"),
			KubeDNS:                   m("gcr.io/google_containers/k8s-dns-kube-dns-arm64:1.15.0"),
			DNSmasq:                   m("gcr.io/google_containers/k8s-dns-dnsmasq-nanny-arm64:1.15.0"),
			KubeDNSSidecar:            m("gcr.io/google_containers/k8s-dns-sidecar-arm64:1.15.0"),
			KubeDNSAutoscaler:         m("gcr.io/google_containers/cluster-proportional-autoscaler-arm64:1.0.0"),
			Flannel:                   m("quay.io/coreos/flannel:v0.10.0-arm64"),
			FlannelCNI:                m("jianghang8421/coreos-flannel-cni-arm64:v0.3.0"),
			...
			MetricsServer:             m("gcr.io/google_containers/metrics-server-arm64:v0.3.1"),
			CoreDNS:                   m("coredns/coredns:1.2.6"),
			CoreDNSAutoscaler:         m("gcr.io/google_containers/cluster-proportional-autoscaler-arm64:1.0.0"),
		},
	}
)
