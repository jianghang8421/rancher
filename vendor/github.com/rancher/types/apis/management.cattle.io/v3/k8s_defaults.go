...
var (
	...
	AllK8sVersions = map[string]RKESystemImages{
		...
		"v1.12.6-rancher1-2": {
			...
			Alpine:                    m("rancher/rke-tools:v0.1.26"),
			NginxProxy:                m("rancher/rke-tools:v0.1.26"),
			CertDownloader:            m("rancher/rke-tools:v0.1.26"),
			KubernetesServicesSidecar: m("rancher/rke-tools:v0.1.26"),
